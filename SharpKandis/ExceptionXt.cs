namespace SharpKandis
{
  ...
  /// <summary>Represents an extension class of all <i>System.Exception</i> classes.</summary>
  public static class ExceptionXt
  {
    #region Methods

    /// <summary>Gets the message of a specified <i>System.Exception</i> including the messages of its inner exceptions.</summary>
