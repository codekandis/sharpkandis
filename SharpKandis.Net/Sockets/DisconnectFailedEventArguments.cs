namespace SharpKandis.Net.Sockets
{
  ...
  /// <summary>Represents the event arguments of a <i>DisconnectFailed</i> event.</summary>
  public class DisconnectFailedEventArguments :
    EventArgs
  {
    #region Properties
    ...
    /// <summary>Initializes the instance of <i>DisconnectFailedEventArguments</i> depending on a specified socket and a specified exception.</summary>
    ...
    public DisconnectFailedEventArguments( Uri uri, EndPoint endPoint, Socket socket, Exception exception )
    {
      this.Uri = uri;
