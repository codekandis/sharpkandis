namespace SharpKandis.Net.Sockets
{
  ...
  /// <summary>Represents the event arguments of a <i>RequestSucceed</i> event.</summary>
  public class RequestSucceedEventArguments :
    EventArgs
  {
    #region Properties
    ...
    /// <summary>Initializes the instance of <i>RequestSucceedEventArguments</i> depending on a specified socket.</summary>
    ...
    public RequestSucceedEventArguments( Uri uri, EndPoint endPoint, Socket socket )
    {
      this.Uri = uri;
