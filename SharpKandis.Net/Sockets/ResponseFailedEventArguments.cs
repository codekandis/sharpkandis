namespace SharpKandis.Net.Sockets
{
  ...
  /// <summary>Represents the event arguments of a <i>ResponseFailed</i> event.</summary>
  public class ResponseFailedEventArguments :
    EventArgs
  {
    #region Properties
    ...
    /// <summary>Initializes the instance of <i>ResponseFailedEventArguments</i> depending on a specified socket and a specified exception.</summary>
    ...
    public ResponseFailedEventArguments( Uri uri, EndPoint endPoint, Socket socket, Exception exception )
    {
      this.Uri = uri;
