namespace SharpKandis.Net.Sockets
{
  ...
  /// <summary>Represents the event arguments of a <i>ConnectSucceed</i> event.</summary>
  public class ConnectSucceedEventArguments :
    EventArgs
  {
    #region Properties
    ...
    /// <summary>Initializes the instance of <i>ConnectSucceedEventArguments</i> depending on a specified socket.</summary>
    ...
    public ConnectSucceedEventArguments( Uri uri, EndPoint endPoint, Socket socket )
    {
      this.Uri = uri;
