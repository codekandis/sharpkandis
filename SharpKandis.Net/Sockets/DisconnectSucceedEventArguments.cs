namespace SharpKandis.Net.Sockets
{
  ...
  /// <summary>Represents the event arguments of a <i>DisconnectSucceed</i> event.</summary>
  public class DisconnectSucceedEventArguments :
    EventArgs
  {
    #region Properties
    ...
    /// <summary>Initializes the instance of <i>DisconnectSucceedEventArguments</i> depending on a specified socket.</summary>
    ...
    public DisconnectSucceedEventArguments( Uri uri, EndPoint endPoint, Socket socket )
    {
      this.Uri = uri;
