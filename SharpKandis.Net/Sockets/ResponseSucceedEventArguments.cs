namespace SharpKandis.Net.Sockets
{
  ...
  /// <summary>Represents the event arguments of a <i>ResponseSucceed</i> event.</summary>
  public class ResponseSucceedEventArguments :
    EventArgs
  {
    #region Properties
    ...
    /// <summary>Initializes the instance of <i>ResponseSucceedEventArguments</i> depending on a specified socket.</summary>
    ...
    public ResponseSucceedEventArguments( Uri uri, EndPoint endPoint, Socket socket )
    {
      this.Uri = uri;
