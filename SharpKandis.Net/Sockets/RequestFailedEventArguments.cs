namespace SharpKandis.Net.Sockets
{
  ...
  /// <summary>Represents the event arguments of a <i>RequestFailed</i> event.</summary>
  public class RequestFailedEventArguments :
    EventArgs
  {
    #region Properties
    ...
    /// <summary>Initializes the instance of <i>RequestFailedEventArguments</i> depending on a specified socket and a specified exception.</summary>
    ...
    public RequestFailedEventArguments( Uri uri, EndPoint endPoint, Socket socket, Exception exception )
    {
      this.Uri = uri;
